...
plutovg_paint_t* plutovg_paint_create_conical_gradient(float cx, float cy, float angle, plutovg_spread_method_t spread, const plutovg_gradient_stop_t* stops, int nstops, const plutovg_matrix_t* matrix)
{
