...
void plutovg_canvas_set_conical_gradient(plutovg_canvas_t* canvas, float cx, float cy, float angle, plutovg_spread_method_t spread, const plutovg_gradient_stop_t* stops, int nstops, const plutovg_matrix_t* matrix)
{
    plutovg_paint_t* paint = plutovg_paint_create_conical_gradient(cx, cy, angle, spread, stops, nstops, matrix);
